...
/*si $_post['civility'] n'est pas vide
si c'est pas vide on vérifi si $_POST ['civility = 0 ou 1'] 
si ok on ecrit la variable qui appelle le tableau initialisé au début et qui contient le select de l utilisateur 
